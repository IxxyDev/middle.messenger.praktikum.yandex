    ...
    click: [
      ...
      },
      {
        ...
        fn: e => {
          ...
          if (popup !== 'createChatPopup') return
      ...
      },
      {
        ...
        fn: () => {
          ...
          GetUsersByChatController.getUsersByChat(selectedChatId as number)
        }
      },
      {
        ...
        fn: e => {
          ...
          if (clickedElement !== 'closeAddUserPopup') return
      ...
      },
      {
        ...
        fn: e => {
          const clickedElement = (e.target as HTMLElement).getAttribute('id')
          if (clickedElement !== 'closeDeleteUserPopup') return
